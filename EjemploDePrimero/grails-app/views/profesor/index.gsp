		...
		<div id="list-profesor" class="content scaffold-list" role="main">
			...
			<thead>
					<tr>
						...
						<g:sortableColumn property="primerApellido" title="${message(code: 'profesor.primerApellido.label', default: 'Primer Apellido')}" />
					
						<g:sortableColumn property="segundoApellido" title="${message(code: 'profesor.segundoApellido.label', default: 'Segundo Apellido')}" />
						...
						<th><g:message code="profesor.despacho.label" default="Despacho" /></th>
				...
				<g:each in="${profesorInstanceList}" status="i" var="profesorInstance">
					<tr class="${(i % 2) == 0 ? 'even' : 'odd'}">
						...
						<td>${fieldValue(bean: profesorInstance, field: "primerApellido")}</td>
					
						<td>${fieldValue(bean: profesorInstance, field: "segundoApellido")}</td>
					
						<td>${fieldValue(bean: profesorInstance, field: "dni")}</td>
					
						<td>${fieldValue(bean: profesorInstance, field: "email")}</td>
					
						<td>${fieldValue(bean: profesorInstance, field: "despacho")}</td>
