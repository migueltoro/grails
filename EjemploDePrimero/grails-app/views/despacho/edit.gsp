...
<html>
	...
	<body>
		<a href="#edit-despacho" class="skip" tabindex="-1"><g:message code="default.link.skip.label" default="Skip to content&hellip;"/></a>
		...
		<div id="edit-despacho" class="content scaffold-edit" role="main">
			...
			<g:form url="[resource:despachoInstance, action:'update']" method="PUT" >
				<g:hiddenField name="version" value="${despachoInstance?.version}" />
				<fieldset class="form">
