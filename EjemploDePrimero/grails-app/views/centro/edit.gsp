...
<html>
	...
	<body>
		...
		<div id="edit-centro" class="content scaffold-edit" role="main">
			...
			<g:hasErrors bean="${centroInstance}">
			<ul class="errors" role="alert">
				<g:eachError bean="${centroInstance}" var="error">
				<li <g:if test="${error in org.springframework.validation.FieldError}">data-field-id="${error.field}"</g:if>><g:message error="${error}"/></li>
				</g:eachError>
			</ul>
			</g:hasErrors>
			<g:form url="[resource:centroInstance, action:'update']" method="PUT" >
				<g:hiddenField name="version" value="${centroInstance?.version}" />
				<fieldset class="form">
